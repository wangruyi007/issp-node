var app = angular.module('rentUpload', ['toastr']);
app.controller('rentUploadCtrl', function ($scope, rentSer, $state, toastr, $http, $stateParams) {
