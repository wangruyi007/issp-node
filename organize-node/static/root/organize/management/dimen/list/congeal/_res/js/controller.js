var app = angular.module('dimenCongeal', ['toastr','ipCookie']);
app.controller('dimenCongealCtrl',function($scope,dimensionSer,toastr,$stateParams,$state,ipCookie,$location){
    //冻结
