var app = angular.module('motypeList', ['ng-pagination','toastr']);
app.controller('motypeListCtrl',function($scope,toastr,motypeSer){
    ...
    function activatePage(page) {
        ...
        motypeSer.listMotype(pages).then(function(response){
