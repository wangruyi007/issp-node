var app = angular.module('motypeCongeal', ['toastr','ipCookie']);
app.controller('motypeCongealCtrl',function($scope,toastr,$stateParams,$state,motypeSer,$location,ipCookie){
    //删除
