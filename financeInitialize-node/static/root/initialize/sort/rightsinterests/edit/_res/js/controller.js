 ...
 */
var app = angular.module('rightsinterestsEdit', ['toastr','ipCookie']);
app.controller('rightsinterestsEdit', function($scope, assetsSer,$state,toastr,$stateParams,ipCookie,$location){
