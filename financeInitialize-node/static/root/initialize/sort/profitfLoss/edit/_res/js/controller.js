 ...
 */
var app = angular.module('profitfLossEdit', ['toastr','ipCookie']);
app.controller('profitfLossEditCtrl', function($scope, assetsSer,$state,toastr,$stateParams,ipCookie,$location){
