var app = angular.module('deparHead', ['toastr']);
app.controller('deparHeadCtrl', function($scope, deparSer,$stateParams,$state,toastr){
    $scope.showed=true
    ...
    $scope.deparEditFun = function(){
        var vm = $scope;
        deparSer.deparHead(vm.depar).then(function(response){
            if(response.data.code == 0){
