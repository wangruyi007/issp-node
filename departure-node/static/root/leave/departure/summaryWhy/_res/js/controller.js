...
var app = angular.module('summaryWhy', ['toastr']);
app.controller('summaryWhyCtrl', function($scope, deparSer,toastr){
   // //部门
   ...
   //  });
        ...
        console.log(vm.sum)
        deparSer.deparSummaryWhy(vm.sum).then(function(response){
            if(response.data.code == 0){
