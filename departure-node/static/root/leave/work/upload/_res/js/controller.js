var app = angular.module('workUpload', ['toastr']);
app.controller('workUploadCtrl', function ($scope, workSer, $state, toastr, $http, $stateParams) {
