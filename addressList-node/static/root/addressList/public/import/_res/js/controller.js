var app = angular.module('publicImport', ['toastr']);
app.controller('publicImportCtrl', function($scope,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/public/templateExcel');
    };
    //删除文件
