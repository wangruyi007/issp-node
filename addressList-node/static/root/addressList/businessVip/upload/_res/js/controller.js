var app = angular.module('businessVipUpload', ['toastr']);
app.controller('businessVipUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
