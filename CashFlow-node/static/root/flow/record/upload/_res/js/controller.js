var app = angular.module('recordUpload', ['toastr']);
app.controller('recordUploadCtrl', function ($scope, recordSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/moneyUploadFile/uploadFile',
                headers: {
