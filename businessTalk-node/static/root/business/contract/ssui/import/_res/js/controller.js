var app = angular.module('ssuiImport', ['toastr']);
app.controller('ssuiImportCtrl', function($scope, ssuiSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/ssuiImport/templateExport');
    };
    //删除文件
