var app = angular.module('ssuiView', ['toastr']);
app.controller('ssuiViewCtrl', function($scope,ssuiSer,$stateParams,toastr,$http,$state){
    ...
    //获取附件列表
    ssuiSer.ssuiFiles(pathData).then(function(response){
    ...
    $scope.view  =function(){
        ...
        angular.element('.checked-none').attr('checked',false);//清空全选框
            ...
            if($stateParams.view == '1'){
                $state.go('root.businessContract.ssuiProject.view[12]',{view:'2'});
            }else if($stateParams.view == '2'){
                $state.go('root.businessContract.ssuiProject.view[12]',{view:'1'});
            }
        }
    };
