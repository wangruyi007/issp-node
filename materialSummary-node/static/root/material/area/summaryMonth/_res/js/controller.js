...
app.controller('summaryMonthCtrl', function($scope, areaSer,toastr){
    $scope.showed=true;
    ...
    $scope.collect = function(){
        ...
        areaSer.areaSummaryMonth(vm.sum).then(function(response){
            ...
            //第二层
                ...
                for(var i = 0;i < $scope.data.length;i++){
                    if (i == 0){
                        $scope.arr2[index2] = {};
                        $scope.arr2[index2].name2 = $scope.data[i].projectGroup;
                        $scope.arr2[index2].length2 = 1;
                    }
                    if(i !== 0){
                        if($scope.data[i].projectGroup == before2){
                            $scope.arr2[index2].length2 +=1;
                        }else if($scope.data[i].projectGroup != before2){
                            index2 +=1;
                            $scope.arr2[index2] = {};
                            $scope.arr2[index2].name2 = $scope.data[i].projectGroup;
                            $scope.arr2[index2].length2 = 1;
                    ...
                    before2 = $scope.data[i].projectGroup;
                    // console.log(before2)
                }
