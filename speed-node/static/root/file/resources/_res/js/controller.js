var app = angular.module('resources', [{
    files:[
        "root/file/resources/_res/js/service.js"
    ]
}]);
app.controller('resourcesCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.file.resources.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
            $scope.menuClass = 'deleteMenu'
        }
    };
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.file.resources.edit[12]',{id:$scope.idList,page:$scope.page});
