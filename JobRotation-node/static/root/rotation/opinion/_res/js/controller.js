...
app.controller('MaterialCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idListd){
            $state.go('root.rotation.opinion.list[12]',{id:$scope.idListd,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idListd){
            $state.go('root.rotation.opinion.edit[12]',{id:$scope.idListd,page:$scope.page});
            $scope.menuClass = 'editMenu'
        }
    }
    $scope.upload = function(){
        if($scope.idListd){
            $state.go('root.rotation.opinion.upload[12]',{id:$scope.idListd});
            $scope.menuClass = 'uploadMenu'
        }
    }
    $scope.view = function(){
        if($scope.idListd){
            $state.go('root.rotation.opinion.view[12]',{id:$scope.idListd});
