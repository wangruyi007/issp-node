(function () {
    ...
    page.directive('ueditor', [
        ...
        function ($templateCache) {
            return {
                restrict: 'AE',
                template: '<script id="ueditorId" name="content" type="text/plain" style="width:300px;">这里写你的初始化内容</script>',
                scope: false,
                    ...
                    return {
                        pre: function (scope, iElement, iAttrs, controller) {
                            var editorFunctions = ['fullscreen', 'source', '|', 'undo', 'redo', '|', 'bold',
                                ...
                                'touppercase', 'tolowercase','attachment', '|', 'link', 'unlink', 'anchor', '|', 'imagenone',
                            ...
                            var editor = UE.getEditor(scope.ueditorId, {
                                ...
                                saveInterval: scope.config.saveInterval ? scope.config.saveInterval : 1000,  //自动保存间隔时间， 单位ms  
