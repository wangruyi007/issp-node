...
app.controller('teamSummaryCtrl', function($scope, billRecordsSer,toastr,$location,ipCookie){

    $scope.showed=true;
    // 获取项目组
    billRecordsSer.getTeam().then(function(response){
    ...
    $scope.collect = function(){
        ...
        billRecordsSer.teamSummary(vm.sum).then(function(response){
            if(response.data.code == 0){
