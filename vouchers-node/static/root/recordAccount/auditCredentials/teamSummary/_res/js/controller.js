...
app.controller('teamSummaryCtrl', function($scope, credentialsSer,toastr,$location,ipCookie){

    $scope.showed=true;
    // 获取项目组
    credentialsSer.getTeam().then(function(response){
    ...
    $scope.collect = function(){
        ...
        credentialsSer.teamSummary(vm.sum).then(function(response){
            if(response.data.code == 0){
