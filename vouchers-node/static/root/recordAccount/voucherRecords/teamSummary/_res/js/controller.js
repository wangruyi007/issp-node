...
app.controller('teamSummaryCtrl', function($scope, voucherRecordsSer,toastr,$location,ipCookie){

    $scope.showed=true;
    // 获取项目组
    voucherRecordsSer.getTeam().then(function(response){
    ...
    $scope.collect = function(){
        ...
        voucherRecordsSer.teamSummary(vm.sum).then(function(response){
            if(response.data.code == 0){
