...
app.controller('projectNameSummaryCtrl', function($scope, voucherRecordsSer,toastr,$location,ipCookie){
    ...
    $scope.collect = function(){
        ...
        voucherRecordsSer.projectSummary(vm.sum).then(function(response){
            if(response.data.code == 0){
