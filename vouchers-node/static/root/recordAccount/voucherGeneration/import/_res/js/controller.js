var app = angular.module('voucherImport', ['toastr']);
app.controller('importCtrl', function($scope,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/vouchergenerate/templateExport');
    };
    //删除文件
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/vouchergenerate/importExcel',
                headers: {
