...
app.controller('emailCtrl',function ($scope,$state) {
    ...
    $scope.congeal = function(){
        if($scope.idList){
            $state.go('root.marketActivity.email.list[12]',{id:$scope.idList,name:'congeal',page:$scope.page});
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.marketActivity.email.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.marketActivity.email.edit[12]',{id:$scope.idList,page:$scope.page});
