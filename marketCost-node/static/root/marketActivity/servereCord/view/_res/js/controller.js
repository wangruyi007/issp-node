...
app.controller('mviewCtr',function($scope,servereCordSer,toastr,$stateParams,$state) {
   ...
   //选择
    ...
    $scope.submit = function(){
        ...
        servereCordSer.editCustomer(data).then(function(response){
    ...
    servereCordSer.viewCustomer(companyId).then(function(response){
        if(response.data.code == 0){
