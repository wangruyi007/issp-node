var app = angular.module('Arganize', ['toastr','ipCookie']);
app.controller('servercordOpinionCtr',function($scope,servereCordSer,$state,toastr,$stateParams,ipCookie,$location){
