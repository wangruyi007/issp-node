...
app.controller('exportCtr', function($scope,$state,toastr,marketserveSer){

    $scope.firstCompany = [];
    $scope.stringSettings = {template : '{{option}}', smartButtonTextConverter(skip, option) { return option; }};
    $scope.showed = true;
    //获取所有地区
    marketserveSer.getAllAreas().then(function(response){
    ...
    $scope.workersAddFun = function(){
        ...
        window.open(`/marketActivity/exportFile${encode(obj,true)}`);
    };
