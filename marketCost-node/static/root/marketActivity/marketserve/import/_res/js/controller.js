var app = angular.module('Import', ['toastr']);
app.controller('importCtr', function($scope, marketserveSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/marketActivity/templateExport');
    };
    //删除文件
