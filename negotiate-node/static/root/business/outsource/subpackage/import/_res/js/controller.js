var app = angular.module('subpackageImport', ['toastr']);
app.controller('subpackageImportCtrl', function($scope, subpackageSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/subpackageImport/templateExport');
    };
    //删除文件
