var app = angular.module('shareholderImport', ['toastr']);
app.controller('shareholderImportCtrl', function($scope,shareholderSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/shareholder/templateExport');
    };
    //删除文件
