var app = angular.module('payotherImport', ['toastr']);
app.controller('payotherImportCtrl', function($scope,payotherSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/payother/templateExport');
    };
    //删除文件
