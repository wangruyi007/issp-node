var app = angular.module('payotherAdd', ['toastr']);
app.controller('payotherAddCtrl', function($scope, payotherSer,$state,toastr){
    //获取所有一级科目
    ...
    $scope.basicAddFun = function(){
        ...
        payotherSer.addContent(vm.add).then(function(response){
            if(response.data.code == 0){
