var app = angular.module('payholderImport', ['toastr']);
app.controller('payholderImportCtrl', function($scope,payholderSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/payholder/templateExport');
    };
    //删除文件
