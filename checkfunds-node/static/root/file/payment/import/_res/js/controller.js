var app = angular.module('paymentImport', ['toastr']);
app.controller('paymentImportCtrl', function($scope, paymentSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/payment/templateExport');
    };
    //删除文件
