var app = angular.module('otherImport', ['toastr']);
app.controller('otherImportCtrl', function($scope,otherSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/other/templateExport');
    };
    //删除文件
