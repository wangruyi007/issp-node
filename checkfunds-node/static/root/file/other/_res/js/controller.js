var app = angular.module('other', [{
    files:[
        "root/file/other/_res/js/service.js"
    ]
}]);
app.controller('otherCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.file.other.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
            $scope.menuClass = 'deleteMenu'
        }
    };
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.file.other.edit[12]',{id:$scope.idList,page:$scope.page});
