var app = angular.module('salaryconfirmUpload', ['toastr']);
app.controller('salaryconfirmUploadCtrl', function ($scope, salaryconfirmSer, $state, toastr, $http, $stateParams) {
   ...
   var oldFiles = [];
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/salaryconfirmUpload/upload',
                headers: {
