var app = angular.module('salaryconfirmImport', ['toastr']);
app.controller('salaryconfirmImportCtrl', function($scope,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/salaryconfirmImport/templateExport');
    };
    //删除文件
