var app = angular.module('creditorUpload', ['toastr']);
app.controller('creditorUploadCtrl', function ($scope, creditorSer, $state, toastr, $http, $stateParams) {
