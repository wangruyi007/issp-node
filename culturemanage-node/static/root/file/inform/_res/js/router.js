...
app.config(function($provide, $stateProvider){
    ...
    }).state("root.file.inform.publicity[12]",{
        url:"/publicity[12]?id=&page=",
        views:{
            "content@root.file.inform":{
                templateUrl : "root/file/inform/publicity/_res/html/index.html",
                controller:'informPublicityCtrl'
            }
        }
    }).state("root.file.inform.plan[12]",{
        url:"/plan[12]?id=&page=",
        views:{
            "content@root.file.inform":{
                templateUrl : "root/file/inform/plan/_res/html/index.html",
                controller:'informPlanCtrl'
            }
        }
    })
});