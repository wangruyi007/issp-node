...
app.controller('fileCtrl', function ($scope,$state) {
    ...
    $scope.navCla='artificial';
    var active = $location.path().split('/')[3];
    $scope.navCla=active?active:'artificial';
    ...
    $scope.showsList = [
        {id:"1",item:"人员编制",menuList:[
            {name:'人工成本计划',msg:'artificial'},
            {name2:'人数配置-计划',msg:'numberPlan'},
            {name3:'人数配置-实际',msg:'numberActua'},
            {name4:'工资区间',msg:'wages'}],showIs:false},
