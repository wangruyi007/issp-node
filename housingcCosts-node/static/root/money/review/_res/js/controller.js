...
app.controller('reviewCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idListd){
            $state.go('root.money.review.list[12]',{id:$scope.idListd,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idListd){
            $state.go('root.money.review.edit[12]',{id:$scope.idListd,page:$scope.page});
