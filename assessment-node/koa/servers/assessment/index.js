...
module.exports = function(){
    ...
    this.basicInfoAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/baseinfo/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.basicInfoEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/baseinfo/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.basicInfoDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/baseinfo/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.demandAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/demandcost/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.demandEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/demandcost/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.demandDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/demandcost/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
...
/*劳动成本*/
    ...
    this.labourAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/labourcost/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.labourEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/labourcost/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.labourDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/labourcost/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.otherAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/anothercost/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.otherEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/anothercost/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.otherDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/anothercost/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.costAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/projectcost/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.costEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/projectcost/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.costDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/projectcost/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.growAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/abilitygrowup/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.growEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/abilitygrowup/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.growDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/abilitygrowup/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.informationAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/marketsesponse/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.informationEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/marketsesponse/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.informationDelete = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/marketsesponse/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.handAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/problemdispose/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.handEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/problemdispose/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.HandDelete = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/problemdispose/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.qualitativeEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/problemdispose/v1/qualitative?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.rationEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/problemdispose/v1/ration?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.moneyDelete = function(argvs){
        var options = {
            method : 'GET',
            timeout : 3000,
            uri : config()['rurl'] + `/businessevaluate/projectamount/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    // 添加
    this.moneyAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/businessevaluate/projectamount/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.moneyEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/businessevaluate/projectamount/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.frontLineAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/frontline/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.frontLineEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/frontline/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.frontLineDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/frontline/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
    ...
    this.chargeAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/business/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.chargeEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/business/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.chargeDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/business/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
...
//项目负责人
    ...
    this.projectAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/projectprincipal/v1/add?userToken=${argvs.userToken}`,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.projectEdit = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + `/projectprincipal/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.projectDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + `/projectprincipal/v1/delete/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
    //获取ID
...
//解冻
    this.resultThaw = function(argvs){
        var options = {
            method : 'PATCH',
            timeout : 3000,
            uri : config()['rurl'] + `/collect/v1/unfreeze/${argvs.id}?userToken=${argvs.userToken}`,
        };
        return request(options);
    };
