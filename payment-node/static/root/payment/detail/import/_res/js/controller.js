var app = angular.module('detailImport', ['toastr']);
app.controller('detailImportCtrl', function($scope, detailSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/detail/templateExport');
    };
    //删除文件
