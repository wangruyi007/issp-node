var app = angular.module('detailedView', ['toastr']);
app.controller('detailedViewCtrl', function($scope,detailedSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    detailedSer.viewQualifiedFile(pathData).then(function(response){
    ...
    $scope.fn = function(){//下载
        for(var i=0,len=$scope.encloCompany.length;i<len;i++){
            ...
            iframe.src=`/detailed/download${encode(obj,true)}`;
