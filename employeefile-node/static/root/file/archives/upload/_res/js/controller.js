var app = angular.module('qualifiedUpload', ['toastr']);
app.controller('qualifiedUploadCtrl', function ($scope, qualifiedSer, $state, toastr, $http, $stateParams) {
