var app = angular.module('staffInformsImport', ['toastr']);
app.controller('staffInformsImportCtrl', function($scope, staffSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/staffInforms/templateExport');
    };
    //删除文件
