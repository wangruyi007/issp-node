...
module.exports = function(){
    ...
    }).get('/management/guidePermission/:guideAddrStatus', function*(){  //员工档案权限-未
        var $self = this;
        var page = {name:$self.params.guideAddrStatus,token:$self.cookies.get('token')};
        yield (server().manPermission(page)
            .then((parsedBody) =>{
                var responseText = JSON.parse(parsedBody);
                $self.body = responseText;
            }).catch((error) =>{
    ...
    }).get('/qualified/guidePermission/:guideAddrStatus', function*(){  //人员资质权限-未
        var $self = this;
        var page = {name:$self.params.guideAddrStatus,token:$self.cookies.get('token')};
        yield (server().manPermission(page)
            .then((parsedBody) =>{
