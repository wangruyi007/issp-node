var app = angular.module('yearindexImport', ['toastr']);
app.controller('yearindexImportCtrl', function($scope, yearindexSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/yearindex/templateExport');
    };
    //删除文件
