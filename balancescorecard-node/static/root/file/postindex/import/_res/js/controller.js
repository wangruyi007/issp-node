var app = angular.module('postindexImport', ['toastr']);
app.controller('postindexImportCtrl', function($scope, postindexSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/postindex/templateExport');
    };
    //删除文件
