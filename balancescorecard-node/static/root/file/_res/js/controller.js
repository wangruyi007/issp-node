...
app.controller('fileCtrl', function ($scope,$state) {
    ...
    $scope.navCla=active?active:'basic';
    ...
    $scope.showsList = [
        {id:"1",item:"基础设置",menuList:[
            {name1:'指标类型',msg:'basic'},
            {name2:'维度设置',msg:'dimension'},
            {name3:'考核方式设置',msg:'assessment'},
            {name4:'指标名称设置',msg:'name'},
        ],showIs:false},
        {id:"2",item:"指标",menuList:[
            {name5:'年度指标',msg:'yearindex'},
            {name6:'部门年度指标',msg:'departindex'},
            {name7:'部门月度指标',msg:'monthindex'},
            {name8:'岗位指标',msg:'postindex'},
            {name9:'我的指标',msg:'mineindex'},
            {name10:'指标库',msg:'libraryindex'},
        ],showIs:false},
        {id:"2",item:"设置",menuList:[{name11:'设置',msg:'setting'}],showIs:false},
    ];
    if(active){
