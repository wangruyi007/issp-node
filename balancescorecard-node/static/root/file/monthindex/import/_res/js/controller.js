var app = angular.module('monthindexImport', ['toastr']);
app.controller('monthindexImportCtrl', function($scope, monthindexSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/monthindex/templateExport');
    };
    //删除文件
