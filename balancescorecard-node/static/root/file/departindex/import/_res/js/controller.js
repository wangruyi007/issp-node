var app = angular.module('departindexImport', ['toastr']);
app.controller('departindexImportCtrl', function($scope, departindexSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/departindex/templateExport');
    };
    //删除文件
