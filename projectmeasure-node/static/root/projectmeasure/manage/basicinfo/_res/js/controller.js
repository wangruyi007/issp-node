var app = angular.module('basicinfo', [{
    files:[
        "root/projectmeasure/manage/basicinfo/_res/js/service.js"
    ]
}]);
app.controller('basicinfoCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.projectmeasure.manage.basicinfo.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.projectmeasure.manage.basicinfo.edit[12]',{id:$scope.idList,page:$scope.page});
    ...
    $scope.view = function(){
        if($scope.idList){
            $state.go('root.projectmeasure.manage.basicinfo.view[12]',{id:$scope.idList,page:$scope.page});
