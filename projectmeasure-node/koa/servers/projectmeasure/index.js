   ...
   this.coststatusList= function(argvs){
    ...
    this.coststatusAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/projectcoststatus/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.coststatusEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/projectcoststatus/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.coststatusDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/projectcoststatus/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.basicinfoList= function(argvs){
    ...
    this.basicinfoAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/projectbasicinfo/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.basicinfoEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/projectbasicinfo/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.basicinfoDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/projectbasicinfo/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.msuiList= function(argvs){
    ...
    this.msuiAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/msui/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.msuiEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/msui/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.msuiDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/msui/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.ssuiList= function(argvs){
    ...
    this.ssuiAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/ssui/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.ssuiEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/ssui/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.ssuiDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/ssui/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.smuiList= function(argvs){
    ...
    this.smuiAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/smui/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.smuiEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/smui/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.smuiDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/smui/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.mmuiList= function(argvs){
    ...
    this.mmuiAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/mmui/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.mmuiEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/mmui/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.mmuiDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/mmui/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.personDemandList= function(argvs){
    ...
    this.personDemandAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/projectpersonneldemand/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.personDemandEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/projectpersonneldemand/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.personDemandDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/projectpersonneldemand/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
   ...
   this.measuresummaryList= function(argvs){
    ...
    this.measuresummaryAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + '/projectmeasuresummary/v1/add'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.measuresummaryEidt = function(argvs){
        var options = {
            method : 'PUT',
            timeout : 3000,
            uri : config()['rurl'] + '/projectmeasuresummary/v1/edit'+'?userToken='+argvs.userToken,
            form:argvs,
            headers : {
                // token : token
            }
    ...
    this.measuresummaryDelete = function(argvs){
        var options = {
            method : 'DELETE',
            timeout : 3000,
            uri : config()['rurl'] + '/projectmeasuresummary/v1/delete/'+argvs.id+'?userToken='+argvs.userToken,
        };
        return request(options);
    };
    //冻结
     this.measuresummaryCongeal = function(argvs){
        var options = {
            method : 'PATCH',
            timeout : 3000,
            uri : config()['rurl'] + '/projectmeasuresummary/v1/congeal/'+argvs.id+'?userToken='+argvs.userToken,
            form:argvs,
        };
        return request(options);
    };
    ...
    this.measuresummaryUnfreeze = function(argvs){
        var options = {
            method : 'PATCH',
            timeout : 3000,
            uri : config()['rurl'] + '/projectmeasuresummary/v1/thaw/'+argvs.id+'?userToken='+argvs.userToken,
            form:argvs,
        };
        return request(options);
    };
