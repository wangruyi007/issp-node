var app = angular.module('signingUpload', ['toastr']);
app.controller('signingUploadCtrl', function ($scope, signingSer, $state, toastr, $http, $stateParams) {
