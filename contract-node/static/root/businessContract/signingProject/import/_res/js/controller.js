var app = angular.module('signingImport', ['toastr']);
app.controller('signingimportCtrl', function($scope, signingSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/siginmanage/templateExport');
    };
    //删除文件
