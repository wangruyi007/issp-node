...
app.controller('basicViewCtrl', function($scope,basicSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    basicSer.viewFiles(pathData).then(function(response){
