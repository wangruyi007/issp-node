var app = angular.module('basicImport', ['toastr']);
app.controller('basicImportCtrl', function($scope, basicSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/baseinfomanage/templateExcel');
    };
    //删除文件
