var app = angular.module('typeView', ['toastr']);
app.controller('typeViewCtrl', function($scope,contractSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    contractSer.viewFiles(pathData).then(function(response){
