var app = angular.module('dispatchImport', ['toastr']);
app.controller('dispatchImportCtrl', function($scope, dispatchSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/dispatchsheet/templateExcel');
    };
    //删除文件
