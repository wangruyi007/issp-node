var app = angular.module('dispatchUpload', ['toastr']);
app.controller('dispatchUploadCtrl', function ($scope, dispatchSer, $state, toastr, $http, $stateParams) {
