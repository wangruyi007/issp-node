...
module.exports = function(){
    ...
    this.signAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/siginmanage/v1/add?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.signEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/siginmanage/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.signAudit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/siginmanage/v1/audit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.infoAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/baseinfomanage/v1/add?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.infoEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/baseinfomanage/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.sheetAdd = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/dispatchsheet/v1/add?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.sheetEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/dispatchsheet/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.categoryEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/contractcategory/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
    ...
    this.MailEdit = function(argvs){
        var options = {
            method : 'POST',
            timeout : 3000,
            uri : config()['rurl'] + `/collectemail/v1/edit?userToken=${argvs.userToken}`,
            form:argvs
        };
        return request(options);
    };
