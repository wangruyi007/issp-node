...
app.controller('cardCtrl', function ($scope,$state) {
    ...
    $scope.showsList = [
        {id:"1",item:"油卡充值准备与支付",menuList:[{name:'资金准备审核'},{name2:"等待付款"},{name3:"已付款"}],showIs:true},
        {id:"3",item:"设置",menuList:[{name4:'设置'}],showIs:true},
    ];
