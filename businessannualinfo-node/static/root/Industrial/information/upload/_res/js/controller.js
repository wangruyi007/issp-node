var app = angular.module('informationUpload', ['toastr']);
app.controller('informationUploadCtrl', function ($scope, informationSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/annualUploadFile/uploadFile',
                headers: {
