var app = angular.module('taxUpload', ['toastr']);
app.controller('taxUploadCtrl', function ($scope, taxSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/changeUploadFile/uploadFile',
                headers: {
