...
app.controller('fileCtrl', function ($scope,$state) {
    ...
    $scope.navCla='proportion';
    var active = $location.path().split('/')[3];
    $scope.navCla=active?active:'proportion';
    ...
    $scope.showsList = [
        {id:"1",item:"比例分配",menuList:[
            {name1:'比例分配',msg:'proportion'},
            {name2:'资金准备',msg:'prepare'},
            {name3:'申请审批',msg:'apply'}
        ],showIs:false},
