var app = angular.module('questionUpload', ['toastr']);
app.controller('questionUploadCtrl', function ($scope, questionSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/questionUploadFile/uploadFile',
                headers: {
