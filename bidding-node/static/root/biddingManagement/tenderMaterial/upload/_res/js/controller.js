var app = angular.module('MaterialUpload', ['toastr']);
app.controller('MaterialUploadCtrl', function ($scope, MaterialSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/materialUploadFile/uploadFile',
                headers: {
