...
//============路由===========
app.use(require(path.join(__dirname,routersPath,'/borrowManage/index.js'))().routes());//借款
app.use(require(path.join(__dirname,routersPath,'/refundManage/index.js'))().routes());//报销
