var app = angular.module('applyRecordUpload', ['toastr']);
app.controller('applyRecordUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
