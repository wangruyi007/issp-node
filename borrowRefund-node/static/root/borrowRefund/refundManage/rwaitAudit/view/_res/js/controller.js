var app = angular.module('rwaitAuditView', ['toastr']);
app.controller('rwaitAuditViewCtrl', function($scope,rwaitAuditSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    rwaitAuditSer.viewSigning(pathData).then(function(response){
    ...
    $scope.view  =function(){
        ...
        angular.element('.checked-none').attr('checked',false);//清空全选框
            ...
            if($stateParams.view == '1'){
                $state.go('root.borrowRefund.refundManage.rwaitAudit.view[12]',{view:'2'});
            }else if($stateParams.view == '2'){
                $state.go('root.borrowRefund.refundManage.rwaitAudit.view[12]',{view:'1'});
            }
        }
    };
