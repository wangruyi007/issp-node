var app = angular.module('businessCheckView', ['toastr']);
app.controller('businessCheckViewCtrl', function($scope,businessCheckSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    businessCheckSer.viewSigning(pathData).then(function(response){
    ...
    $scope.view  =function(){
        ...
        angular.element('.checked-none').attr('checked',false);//清空全选框
            ...
            if($stateParams.view == '1'){
                $state.go('root.borrowRefund.borrowManage.businessCheck.view[12]',{view:'2'});
            }else if($stateParams.view == '2'){
                $state.go('root.borrowRefund.borrowManage.businessCheck.view[12]',{view:'1'});
            }
        }
    };
