var app = angular.module('businessCheckUpload', ['toastr']);
app.controller('businessCheckUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
