var app = angular.module('borrowRecordView', ['toastr']);
app.controller('borrowRecordViewCtrl', function($scope,borrowRecordSer,$stateParams,toastr,$http,$state){
    ...
    //获取ID
    borrowRecordSer.viewSigning(pathData).then(function(response){
    ...
    $scope.view  =function(){
        ...
        angular.element('.checked-none').attr('checked',false);//清空全选框
            ...
            if($stateParams.view == '1'){
                $state.go('root.borrowRefund.borrowManage.borrowRecord.view[12]',{view:'2'});
            }else if($stateParams.view == '2'){
                $state.go('root.borrowRefund.borrowManage.borrowRecord.view[12]',{view:'1'});
            }
        }
    };
