var app = angular.module('targetInfoUpload', ['toastr']);
app.controller('targetInfoUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/targetinformation/uploadEnclosure',
                headers: {
