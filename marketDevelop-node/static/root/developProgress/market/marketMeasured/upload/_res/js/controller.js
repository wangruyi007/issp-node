var app = angular.module('measuredUpload', ['toastr']);
app.controller('measuredUploadCtrl', function ($scope, measuredSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/marketmeasure/uploadEnclosure',
                headers: {
