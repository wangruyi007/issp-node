var app = angular.module('marketMiningUpload', ['toastr']);
app.controller('marketMiningUploadCtrl', function ($scope, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/marketchannel/uploadEnclosure',
                headers: {
