var app = angular.module('researchUpload', ['toastr']);
app.controller('researchUploadCtrl', function ($scope, researchSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/marketresearch/uploadEnclosure',
                headers: {
