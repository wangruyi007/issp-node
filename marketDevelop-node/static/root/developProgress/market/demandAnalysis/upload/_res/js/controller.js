var app = angular.module('analysisUpload', ['toastr']);
app.controller('analysisUploadCtrl', function ($scope, demandAnalysisSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/demandanalysis/uploadEnclosure',
                headers: {
