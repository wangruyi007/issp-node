var app = angular.module('dayPlanUpload', ['toastr']);
app.controller('dayPlanUploadCtrl', function ($scope, dayPlanSer, $state, toastr, $http, $stateParams) {
