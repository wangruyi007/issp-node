var app = angular.module('weekPlanUpload', ['toastr']);
app.controller('weekPlanUploadCtrl', function ($scope, weekPlanSer, $state, toastr, $http, $stateParams) {
