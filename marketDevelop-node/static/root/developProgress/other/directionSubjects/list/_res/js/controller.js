...
app.controller('subjectsListCtrl',function($scope,directionSer,toastr,$stateParams,$state){
        ...
        directionSer.courseDelete(data).then(function(response){
            if(response.data.code==0){
                ...
                if(($scope.custom.itemsCount-count)%10){
                    ...
                    $state.go('root.developProgress.other.directionSubjects.list[12]',{id:null,name:null,page:$stateParams.page-1});
                }
            }else{
                toastr.error( response.data.msg, '温馨提示');
            }
