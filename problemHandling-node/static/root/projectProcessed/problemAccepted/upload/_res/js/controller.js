var app = angular.module('problemUpload', ['toastr']);
app.controller('problemUploadCtrl', function ($scope, problemSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/problemUploadFile/uploadFile',
                headers: {
