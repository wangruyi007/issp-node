var app = angular.module('confirmUpload', ['toastr']);
app.controller('confirmUploadCtrl', function ($scope, confirmSer, $state, toastr, $http, $stateParams) {
    ...
    $scope.updataSel = function () {
        ...
        if (_files.length) {
            ...
            $http({
                method: 'POST',
                url: '/confirmUploadFile/uploadFile',
                headers: {
