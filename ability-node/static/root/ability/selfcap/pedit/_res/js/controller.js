 ...
 */
var app = angular.module('selfcapPEdit', ['toastr']);
app.controller('selfcapPEditCtrl', function($scope, selfcapSer,$state,toastr,$stateParams){
    ...
    $scope.selfcapPaEditFun = function(){
        var vm = $scope;
        var data = {
            id:vm.peditInfo.id,
        ...
        selfcapSer.editEditSocial(data).then(function(response){
            if(response.data.code == 0){
