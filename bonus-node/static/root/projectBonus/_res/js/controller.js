var app = angular.module('bidding', [{
    files: ['root/projectBonus/_res/js/service.js']
}]);
app.controller('biddingCtrl', function ($scope,$state) {
    ...
    $scope.showsList = [
        {id:"1",item:"项目奖金包管理",menuList:[{name:'流程绩效指标管理',msg:'bonus'},{name2:'奖励明细',msg:'reward'},{name3:'处罚明细',msg:'punishment'}],showIs:false},
