...
app.controller('outsourcingFeeCtrl',function ($scope,$state) {
...
}).controller('outsourcingFeeMenuCtrl',function($scope,$state,$rootScope,$location,outsourcingSer){
    ...
    $scope.menuCheck = function (name) {
        ...
        outsourcingSer.menuPermission(buttonName).then(function(response){
    ...
    $scope.delete = function(){
        if($scope.idListd){
            $state.go('root.managementFee.outsourcingFee.list[12]',{id:$scope.idListd,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idListd){
            $state.go('root.managementFee.outsourcingFee.edit[12]',{id:$scope.idListd,page:$scope.page});
