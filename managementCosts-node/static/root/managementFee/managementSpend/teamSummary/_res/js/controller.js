...
app.controller('teamSummaryCtrl', function($scope, spendSer,toastr){

    $scope.showed=true;
    // 获取项目组
    spendSer.getTeam().then(function(response){
    ...
    $scope.collect = function(){
        ...
        spendSer.teamSummary(vm.sum).then(function(response){
            if(response.data.code == 0){
