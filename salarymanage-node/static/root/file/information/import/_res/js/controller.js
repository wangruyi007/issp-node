var app = angular.module('informationImport', ['toastr']);
app.controller('informationImportCtrl', function($scope, informationSer,$state,toastr,$http,$stateParams){
    ...
    $scope.moduleUp = function(){//下载模板
        window.open('/information/templateExport');
    };
    //删除文件
