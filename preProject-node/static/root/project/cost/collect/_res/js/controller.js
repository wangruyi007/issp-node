var app = angular.module('costCollect', ['toastr']);
app.controller('costCollectCtrl', function($scope,$state,toastr,costSer){
    //查询所有年份
    ...
    $scope.collect = function(){
        ...
        costSer.collectArea(data).then(function(response){
