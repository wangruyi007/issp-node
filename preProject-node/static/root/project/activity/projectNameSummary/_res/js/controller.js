var app = angular.module('actProjectNameSummary', ['toastr']);
app.controller('actProjectNameSummaryCtrl', function($scope,$state,toastr,activitySer){
    $scope.collect = function(){
        var data = {
            startTime:angular.element('.startTime').val(),
            endTime:angular.element('.endTime').val()
        };
        activitySer.summaryProjectNameByOrder(data).then(function(response){
