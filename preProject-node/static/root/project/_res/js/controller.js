var app = angular.module('business', [{
    files: ['root/project/_res/js/service.js']
}]);
app.controller('businessCtrl', function ($scope,$state) {
    ...
    $scope.showsList = [
        {id:"1",item:"项目前期的市场活动费",menuList:[{name:'预警设计'},{name2:"等级设计"}],showIs:true},
        {id:"2",item:"费用分析",menuList:[{name3:'费用效益分析'}],showIs:true},
        {id:"3",item:"项目前期的市场活动费",menuList:[{name4:'项目前期的市场活动费'}],showIs:true},
        {id:"4",item:"设置",menuList:[{name5:'设置'}],showIs:true},
    ];
