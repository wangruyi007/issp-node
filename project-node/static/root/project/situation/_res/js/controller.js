...
app.controller('situationCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.project.situation.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.project.situation.edit[12]',{id:$scope.idList,page:$scope.page});
