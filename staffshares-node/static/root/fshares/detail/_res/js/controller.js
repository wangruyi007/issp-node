...
app.controller('detailCtrl',function ($scope,$state) {
    ...
    $scope.menuCheck = function (name) {
        ...
        detailSer.detailPermission(buttonName).then(function(response){
    ...
    detailSer.detailPermission().then(function(response){
