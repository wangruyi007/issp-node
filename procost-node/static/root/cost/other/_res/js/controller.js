var app = angular.module('other', [{
    files:[
        "root/cost/other/_res/js/service.js"
    ]
}]);
app.controller('otherCtrl',function ($scope,$state) {
    ...
    $scope.delete = function(){
        if($scope.idList){
            $state.go('root.cost.other.list[12]',{id:$scope.idList,name:'delete',page:$scope.page});
    ...
    $scope.edit = function(){
        if($scope.idList){
            $state.go('root.cost.other.edit[12]',{id:$scope.idList,page:$scope.page});
