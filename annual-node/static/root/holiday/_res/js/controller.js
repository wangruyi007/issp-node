...
app.controller('biddingCtrl', function ($scope,$state) {
    ...
    $scope.navCla=active?active:'annual';
    ...
    $scope.showsList = [
        {id:"1",item:"年假信息",menuList:[{name:'年假信息记录',msg:'annual'},{name2:'年假申请记录',msg:'leave'}],showIs:false},
        {id:"2",item:"年假管理",menuList:[{name3:'年假标准管理',msg:'management'}],showIs:false},
